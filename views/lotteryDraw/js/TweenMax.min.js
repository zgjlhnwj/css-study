 ...
 * 
 * http://greensock.com/get-started-js http://greensock.com/stagger http://greensock.com/sequence-video  http://greensock.com/learning/ 用法用例
 * TweenMax.to(box2, 3, {rotationY:360, transformOrigin:"left 50% -200"})   改变变形的注册点。
 * TweenLite.killTweensOf(myElement);  停止某个元素上的所有缓动。
 * 缓动函数
 * BounceIn BounceOut BounceInOut
 * CircIn CircInOut CircInOut
 ...
 * TweenMax.staggerFrom(".square",2,{x:300,ease:Bounce.easeOut},0.2,"stagger")
 * TweenMax.staggerTo(".square",2,{x:300,ease:Bounce.easeOut},0.2)
 *
